...
namespace CoolPlugins.Public.Tools
{
    ...
    public static class ConvertExt
    {
        ...
        /// <summary>
        /// 通过将最少量的一组字符（\、*、+、?、|、{、[、(、)、^、$、.、# 和空白）替换为其转义码
        /// ，将这些字符转义。此操作指示正则表达式引擎以字面意义而非按元字符解释这些字符
        /// </summary>
        ...
        /// <returns></returns>
        public static string ToMD5(this string inputstr, string otherstr)
        {
